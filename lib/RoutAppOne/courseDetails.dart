...
class CourseDetails extends StatelessWidget {
  static const String routName = "coursedetails";
...
• Creating final project depends on attendees needs"""
  ...
  Widget build(BuildContext context) {
    var args = ModalRoute.of(context)?.settings.arguments as CoursesModel;
    return Container(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Container(
                  margin: EdgeInsets.all(10), child: Image.asset(args.path)),
              Container(
                  margin: EdgeInsets.all(10),
                  child: Text(
                    alldetails[args.index],
